...
Each project is independent and has its own setup instructions. Please refer to the individual project READMEs for specific installation and usage guidelines.

## Development

This is a monorepo structure where each project can be developed independently. Navigate to the specific project directory to work on that particular application.
